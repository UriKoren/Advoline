...
python -m pip install -q -r %PROJECT_NAME%/server/requirements.txt
...
python %PROJECT_NAME%\server\advoline_server\manage.py collectstatic --no-input --clear
xcopy %PROJECT_NAME%\server\advoline_server\static output\%PROJECT_NAME%\static\static\ /eqv
